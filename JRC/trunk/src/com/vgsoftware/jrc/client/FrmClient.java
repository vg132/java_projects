...
/**
 * Main client window, to this window a {@link com.vgsoftware.jrc.client.panel.Server} and zero or more {@link com.vgsoftware.jrc.client.Client}.
 */
public class FrmClient extends JFrame implements ActionListener
{
	 ...
	 * @param cmc
	 */
	public FrmClient(ClientMessageCenter cmc)
	{
		super();
		this.cmc=cmc;
	...
	public void actionPerformed(ActionEvent arg)
	{
		...
		{
			String label=((JMenuItem)arg.getSource()).getText();
