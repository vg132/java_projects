...
public class Channel extends JRCPanel implements ActionListener
{
	...
	class ChannelKeyListener extends KeyAdapter
	{
		public void keyPressed(KeyEvent arg)
		{
			...
			{
				cmc.encodeMessage(ClientMessageCenter.CHAT,txtField.getText(),name,""+btnColor.getBackground().getRGB());
	...
	public void actionPerformed(ActionEvent arg)
	{
		if(arg.getSource() instanceof JMenuItem)
		{
			...
			if(menu.getText().equals("Whois"))
				cmc.encodeMessage(ClientMessageCenter.WHOIS,((String)users.getSelectedValue()));
		}
