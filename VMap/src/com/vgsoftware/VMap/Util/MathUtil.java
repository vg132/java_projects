...
public class MathUtil
{
	...
	public static double pow(double x, double y)
	{
		...
		/*
		 * Conveniently 2^10=1024, so taking the square root 10 times will yield our
		 * estimate for n. In our example n^3=8^2 n^1024 = 8^683.
		 */
		...
		{
			/*
			 * We try to set our estimate equal to the right hand side of the equation
			 * (e.g., 8^2048). If this number is too large, we will have to rescale.
			 */
			...
			/*
			 * here, we handle the condition where our starting point is too large
			 */
		...
		/*************************************************
		 ** We now have an appropriately sized right-hand-side. Starting with this
		 * estimate for n, we proceed.
		 **************************************************/
	...
	public final static double exp(double val)
	{
